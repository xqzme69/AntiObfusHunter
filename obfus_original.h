...
#ifndef ANTIDEBUG_V2
#define ANTIDEBUG_V2 0
#endif

#ifndef MEM_CLEANER__JUST_FOR_FUN
#define MEM_CLEANER__JUST_FOR_FUN 0
#endif
...
#if defined(_MSC_VER)
#pragma message("obfus.h: MSVC compatibility mode uses safe stub macros only.")
#else
...
#if defined(_MSC_VER)
#pragma message("obfus.h doesn't support Visual C/C++. You can use [obfusheader.h] by ac3ss0r to obfuscate this app (https://github.com/ac3ss0r/obfusheader.h)")
#endif
